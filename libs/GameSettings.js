...
{
    // ゲーム全体
    static get FRAMERATE() { return 15; }   // フレームレート（１秒当たりのフレーム数）
    ...
    static get TANK_WAIT_FOR_NEW_BULLET() { return 1000.0; }  // 単位[ms]。1000 x X秒
    static get TANK_LIFE_MAX() { return 3; } // ライフの数は3
